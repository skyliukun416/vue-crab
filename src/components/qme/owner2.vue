<template>
    ...
    <div>
      <div class="common-title">货主乙</div>
...
export default {
    ...
    mounted(){
        ...
        this.orders = o.filter(e=>{return e.owner=='货主乙'});
        this.borders = o.filter(e=>{return e.owner!='货主乙'});
    ...
    methods: {
       ...
       apply(){
          ...
          this.orders = temp.filter(e=>{return e.owner=='货主乙'});
       ...
       buy(){
          ...
          this.orders  = temp.filter(e=>{return e.owner=='货主乙'});
          this.borders  = temp.filter(e=>{return e.owner!='货主乙'});
          localStorage.setItem('qmeOrders', JSON.stringify(temp));
       },
    }
}
